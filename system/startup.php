...
function library($class) {
    ...
    if (defined('DIR_REWRITE')) {
        ...
        if (isset($rewrite['library'][$class])) {
            if($rewrite['library'][$class]['rewrite']) {
                $file  = dirname(DIR_REWRITE) . DIRECTORY_SEPARATOR . 'system/library/' . strtolower($rewrite['library'][$class]['class']) . '.php';
            }
        }
    }
...
// use rewrite router
if (defined('DIR_REWRITE')) {
    require_once(modification(dirname(DIR_SYSTEM) . DIRECTORY_SEPARATOR . 'rewrite' . DIRECTORY_SEPARATOR . 'system/engine/baseObject.php'));
    require_once(modification(dirname(DIR_SYSTEM) . DIRECTORY_SEPARATOR . 'rewrite' . DIRECTORY_SEPARATOR . 'system/engine/abstractModel.php'));
